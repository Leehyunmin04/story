...
const questions = [
  ...
  // finance (금전)
  { text: '요즘 가장 많이 고민하는 건 돈이다.', type: 'finance' },
  { text: '더 큰 수입이나 재정적 여유가 있었으면 좋겠다.', type: 'finance' },
  { text: '지출을 줄이고 싶다.', type: 'finance' },
  { text: '돈을 현명하게 관리하고 싶다.', type: 'finance' },
  { text: '재정적 안정을 이루고 싶다.', type: 'finance' },
  { text: '돈 걱정 없는 삶을 살고 싶다.', type: 'finance' },
];
...
const results = {
  ...
  finance: {
    title: '금전',
    desc: '오~ 너의 고민은 바로 금전이구나! 마음은 굴뚝같은데 통장은 늘 얇았지… 하지만 걱정 마! 이 키링에는 현명한 소비와 재정 안정을 지켜주는 마법이 담겨 있어. 쓸 땐 쓰고, 모을 땐 모아, 네 돈이 더 오래 머물 수 있게 해줄 거야 💰',
  },
};
...
startBtn.addEventListener('click', () => {
  currentQ = 0;
  scores = { wealth: 0, love: 0, career: 0, health: 0, finance: 0 };
  showPage('quiz');
  showQuestion();
});
